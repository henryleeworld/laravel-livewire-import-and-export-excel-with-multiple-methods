...
class ExportController extends Controller
{
    public function array()
    {
        ...
        fclose($handle);
        return Storage::disk('local')->download('files/export.csv');
    }
    ...
    {
        $filename = 'app/files/fast-excel-export.csv';

        (new FastExcel($this->usersGenerator()))->export(storage_path($filename));
